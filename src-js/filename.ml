...
(* uwt-js changes:
   - Filename.quote, dirname etc. can't be used, because your OS at compile time
     differs from the runtime OS :-(
...
(* Nodejs doesn't run on cygwin. So I've removed this code *)
